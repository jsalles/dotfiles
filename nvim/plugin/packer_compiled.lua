...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-lspconfig', 'vim-illuminate'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
