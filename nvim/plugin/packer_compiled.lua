...
_G.packer_plugins = {
  ...
  ["which-key.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/jvsalles/.local/share/nvim/site/pack/packer/opt/which-key.nvim",
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-lspconfig', 'vim-illuminate', 'gitsigns.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
