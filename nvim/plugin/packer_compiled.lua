...
_G.packer_plugins = {
  ...
  ["lightspeed.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/joao.salles/.local/share/nvim/site/pack/packer/opt/lightspeed.nvim"
  },
  ["lsp-rooter.nvim"] = {
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-ts-utils", "null-ls.nvim", "lua-dev.nvim", "nvim-lspinstall" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzy-native.nvim", "plenary.nvim", "popup.nvim" },
    commands = { "Telescope" },
